...
export default function FilterForm(props) {
  return (
    <div className="flex flex-col">
      <label className="font-bold my-1 text-lg md:text-base" for="Category">Categories</label>
      <select className="mb-5 rounded-lg text-lg md:text-base" name="Category" id="Category" value={props.filterCategory} onChange={props.handleCategoryChange}>
