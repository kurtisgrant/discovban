...
export default function Home() {
  ...
  return (
    ...
    <TickerSection items={attractionData}/>
      ...
      <div className="bg-db_green-dark w-full py-3 shadow-lg flex-grow">
            ...
            {updates.length > 0 && (
              <div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {updates.length ? updates.map(update => <UpdateCard data={update} key={update._id} />) : <div className="w-full col-span-full my-5 text-center text-white">No Updates</div>}
                </div>
              </div>)}
